...
## [2.0.0](https://github.com/dusterbloom/higgs/compare/higgs-models-v1.8.0...higgs-models-v2.0.0) (2026-09-19)
...
* **config:** first-class config surface for the MLA latent KV cache ([#263](https://github.com/dusterbloom/higgs/issues/263)) ([cdb3c4e](https://github.com/dusterbloom/higgs/commit/cdb3c4e74677be2471a89ca6c4d826c2b095d662))
...
* **models:** per-tensor quantization settings with dense-mode loading (PR9 / ds4 P2 loader half) ([#260](https://github.com/dusterbloom/higgs/issues/260)) ([92277ca](https://github.com/dusterbloom/higgs/commit/92277cae5c4595d0148b826739633dc0f4619cfc))
* **quantize:** MoE calibration tooling + loader fixes; asymmetric-quality claim negative ([#264](https://github.com/dusterbloom/higgs/issues/264)) ([9c40cce](https://github.com/dusterbloom/higgs/commit/9c40cce8094567ab5923281257a62542af9778e5))
...
* resolve new clippy lints from stable toolchain update ([#286](https://github.com/dusterbloom/higgs/issues/286)) ([8fb011c](https://github.com/dusterbloom/higgs/commit/8fb011c905b619ab017d66dff64156e6baced314))
