...
## [2.0.0](https://github.com/dusterbloom/higgs/compare/higgs-engine-v1.8.0...higgs-engine-v2.0.0) (2026-09-19)
...
* **bench:** context-frontier benchmark with shared cache rollback helper (PR2 / ds4 P8) ([#253](https://github.com/dusterbloom/higgs/issues/253)) ([4510835](https://github.com/dusterbloom/higgs/commit/451083523816e33cf636d796e240c6bb21a0a62d))
...
* **engine:** chunked prefill yield quantum for the batch serving loop (PR8 / ds4 P9) ([#259](https://github.com/dusterbloom/higgs/issues/259)) ([247147e](https://github.com/dusterbloom/higgs/commit/247147eacfa04ad97af6d1b5aca974594e8da736))
* **engine:** disk-backed KV prefix store for restart-resume (PR6 / ds4 P4) ([#257](https://github.com/dusterbloom/higgs/issues/257)) ([0435d11](https://github.com/dusterbloom/higgs/commit/0435d112ff8abf3de65ed554a95e3e3a9b69d690))
...
* inference engine — chunked prefill, prefix cache, thinking budget, MTP ([4fa0971](https://github.com/dusterbloom/higgs/commit/4fa09711096dc40cff8b2b33b6c5ad1b87e4b128))
...
* **models:** MLA latent KV cache with weight absorption for DeepSeek-V2 (PR3 / ds4 P1) ([#254](https://github.com/dusterbloom/higgs/issues/254)) ([482d2ec](https://github.com/dusterbloom/higgs/commit/482d2eceab6d616f9e6e79c37d6af06624c42410))
* **mtp:** release speculative decoding optimizations ([0e5e458](https://github.com/dusterbloom/higgs/commit/0e5e458ce2b59ab5f1a6aaaa1fe91af6f298fe39))
* **mtp:** release speculative decoding optimizations ([1d15599](https://github.com/dusterbloom/higgs/commit/1d15599ea86fccb022d786a56b2904131078b150))
...
* thinking mode support — reasoning parser and chat template ([a3cc52e](https://github.com/dusterbloom/higgs/commit/a3cc52e7e1f3ef12118b011156cc7b7bad6c05fb))
...
* address remaining draft review issues ([4396e88](https://github.com/dusterbloom/higgs/commit/4396e8840e399af4abb60c84dfc4412ba8b2131f))
...
* **deps:** migrate to sha2 0.11 ([#273](https://github.com/dusterbloom/higgs/issues/273)) ([eb817f9](https://github.com/dusterbloom/higgs/commit/eb817f97f6f5fd27c6f6d1f1b99c358fe53c6724))
* doc_markdown lints in detok test comments ([deefbe3](https://github.com/dusterbloom/higgs/commit/deefbe39345669e101b9f1fc5caa90de0aaaa973))
...
* **engine:** clippy clean 6 files on PR [#74](https://github.com/dusterbloom/higgs/issues/74) (85→51 errors) ([7dc7370](https://github.com/dusterbloom/higgs/commit/7dc737052edea2fdf96c4ab7a097051c0ba34562))
* **engine:** prefix cache full-hit, scheduler leak, gather bounds check ([3e35b3f](https://github.com/dusterbloom/higgs/commit/3e35b3f8e3fe83604883418e408bae09e3533c39))
...
* rename first-token detok bindings to avoid shadowing ([8d16696](https://github.com/dusterbloom/higgs/commit/8d16696c2d59750d3d742f203ab7316a4785b2be))
...
* incremental detokenization for streaming generation ([a949e50](https://github.com/dusterbloom/higgs/commit/a949e50fb3a5c2d650c2d7de367eb4afea444138))
