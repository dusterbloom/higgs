...
This project is indexed by GitNexus as **higgs** (3903 symbols, 10220 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/higgs/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/higgs/context` | Codebase overview, check index freshness |
| `gitnexus://repo/higgs/clusters` | All functional areas |
| `gitnexus://repo/higgs/processes` | All execution flows |
| `gitnexus://repo/higgs/process/{name}` | Step-by-step execution trace |
