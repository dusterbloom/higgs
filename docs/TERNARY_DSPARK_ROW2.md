...
<<<<<<< HEAD
For recognized affine 2-bit Qwen3Next Bonsai targets, Higgs now defaults to the exact ternary dSpark verifier path that produced the best measured result. Users no longer need to set the successful benchmark flags manually:
